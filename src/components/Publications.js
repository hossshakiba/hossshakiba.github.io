    ...
    <div id="publicationSection" className="relative scroll-mt-16">
      ...
      <div className="container m-auto px-7 lg:px-10 xl:px-20 2xl:px-28 3xl:px-44 pt-8 md:pt-16">
        <div className="">
          ...
          <p className="text-[#606060] text-sm ">For a complete list of my research works, please look up my <a href="https://scholar.google.com/citations?user=huveR90AAAAJ&hl=en&authuser=1">google scholar.</a></p>
        </div>
