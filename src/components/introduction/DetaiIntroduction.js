        ...
        <div id="aboutSection" className="scroll-mt-32">
            ...
            <div className="mb-32 3xl:mb-40 mt-[3rem] lg:mt-[5rem] 3xl:mt-[8rem]">
                ...
                <p className=" text-gray-dark text-sm md:text-base 2xl:text-lg 3xl:text-xl text-justify mt-2 xl:mt-3 3xl:mt-5">
                    I'm interested in <span className="highlight-thin">multimodal generative models</span> and their <span className="highlight-thin">personalization</span>, with the goal of making visual content creation more controllable, creative, and expressive.
                </p>
                <p className="text-gray-dark text-sm md:text-base 2xl:text-lg 3xl:text-xl text-justify mt-2 xl:mt-3 3xl:mt-5">
