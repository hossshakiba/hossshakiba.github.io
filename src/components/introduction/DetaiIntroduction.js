    ...
    return (
        <div id="aboutSection" className="scroll-mt-32">
            ...
            <div className="mb-32 3xl:mb-40 mt-[2rem] lg:mt-[5rem] 3xl:mt-[8rem]">
                <p className="text-gray text-xl xl:text-2xl 3xl:text-3xl font-medium mb-2 xl:mb-3 hidden md:block">Hello! I’m</p>
                <h2 className="text-gray-dark text-2xl xl:text-3xl 3xl:text-5xl font-semibold hidden md:block"><span className="name-accent">Hossein Shakibania</span></h2>
                <p className="text-gray-dark text-sm md:text-[0.96rem] 2xl:text-base 3xl:text-lg text-justify mt-1 md:mt-4 xl:mt-6 3xl:mt-10">
                    I'm an MS student in <a className="text-blue-500" href="https://www.informatik.tu-darmstadt.de/studium_fb20/im_studium/studiengaenge_liste/aim_msc.en.jsp"> Artificial Intelligence and Machine Learning</a> at Technical University of Darmstadt and a student research assistant at <a className="text-blue-500" href="https://www.informatik.tu-darmstadt.de/mai/multimodal_ai/index.en.jsp">Multimodal AI Lab</a>, led by <a className="text-blue-500" href="https://scholar.google.com/citations?user=3kDtybgAAAAJ&hl=en">Prof. Marcus Rohrbach</a> and <a className="text-blue-500" href="https://scholar.google.com/citations?user=GHpxNQIAAAAJ&hl=en">Prof. Anna Rohrbach</a>. I completed my BS in Computer Engineering in 2024 at Bu-Ali Sina University.
                </p>
                <p className=" text-gray-dark text-sm md:text-[0.96rem] 2xl:text-base 3xl:text-lg text-justify mt-2 xl:mt-3 3xl:mt-5">
