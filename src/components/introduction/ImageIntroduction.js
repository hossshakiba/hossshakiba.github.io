...
const ImageIntroduction = () => {
    ...
    return (
        <div className="hidden md:block">
            ...
            <div className="absolute top-[12rem] lg:top-[12rem] xl:top-[11.5rem] 3xl:top-[13rem] 2xl:bg-cover right-[2%] lg:right-[10%] xl:right-[16%] 2xl:right-[19%] 3xl:right-[18%] flex flex-col items-center">
                <Image alt="" src={person} className="w-[16rem] h-[16rem] 3xl:w-[20rem] 3xl:h-[20rem] rounded-xl object-cover" />
