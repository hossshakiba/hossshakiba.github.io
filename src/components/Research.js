        ...
        <div id="researchSection" className="pb-10 scroll-mt-32">
            <div className="container m-auto">
                <div className="px-7 lg:px-10 xl:px-20 2xl:px-28 3xl:px-44 pt-8 md:pt-16">
                    <h1 className="theme-heading text-xl xl:text-2xl 2xl:text-3xl">Research interests</h1>
                    <div className="theme-heading ml-7 my-6 md:my-12 pl-1 xl:pl-10 2xl:pl-14 pr-2">
                        {research.researchs.map((research, index) =>
                            <div key={index} className="flex sm:items-center my-4 md:my-7 text-xs sm:text-sm md:text-base">
                                <span className="w-1.5 sm:w-2 h-1.5 sm:h-2 mt-1.5 sm:mt-1 mr-3 sm:mx-5 bg-[var(--color-heading)] rounded-full"></span>
